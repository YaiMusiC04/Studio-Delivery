// Scans options chains of the most liquid US stocks and surfaces unusual
// activity (high volume vs. open interest = possible institutional/whale bets).

const LIQUID = [
  // Index ETFs — always the most active
...
function score(contracts, type, price) {
  return contracts
    .filter(c => {
    ...
    .map(c => {
      ...
      return {
        ...
        // Sentiment: deep OTM large call = aggressive bull bet; large put = hedge/bear
...
module.exports = async function handler(req, res) {
  ...
  // Fetch chains in parallel (cap at 24 symbols for speed)
  ...
  // Claude interpretation (fast Haiku)
